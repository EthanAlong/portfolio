...
const realProjects = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "textBlock",
        title: "2026: Cloud-Native Rebuild",
        text: "The system was re-architected as a production cloud service: a Python ingestion pipeline performs vision-language metadata extraction and dual text + image embeddings, and hybrid retrieval lets engineers search by phrase, by filter, or by visual similarity. The stack is provisioned entirely from infrastructure-as-code for reproducible deployment, and the retrieval quality was validated through structured human evaluation before rollout. It now serves the firm's full curated detail library in daily production use.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "textBlock",
        title: "2026: From Site to Platform",
        text: "Over 2026 the suite matured into the firm's daily-driver platform: an automated drawing QA/QC checker that reviews sheet sets for consistency issues, an AI-assisted drafting-standards library where engineers capture and query the firm's drafting conventions in plain language, and an admin center covering people, roles, activity and usage analytics. New tools continue to ship on the shared registry pattern — a page, a route, and it's live.",
      },
    ],
  },
  {
